...
{
		for ($i = 1 ; $i <= 5; $i ++) # cria pos 6 números de cada aposta;
		{				
	...
	printf ( "chave $k --> ");
	print @outarray; # + Estrelas ---> ".@outstars); # imprime a palavra chave mais o número da chave antes de cada linha do array;
	printf (" + Estrelas --- > ");
	print @outstars;	
